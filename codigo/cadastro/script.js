...
let sucesso1 = document.getElementById("div-sucesso");
let error1 = document.getElementById("div-falha");
...
try{
    ...
    nome.addEventListener("keyup", () =>{
        if(nome.value.length <= 2){
            ...
            labelnome.innerHTML = "<strong>Nome</strong> *Insira pelo menos 3 caractéres";
    ...
    senha.addEventListener("keyup", () =>{
        if(senha.value.length < 8){
            ...
            labelsenha.innerHTML = "<strong>Senha</strong> *Senha precisa ter pelo menos 8 caracteres";
    ...
    confSenha.addEventListener("keyup", () =>{
        if(confSenha.value != senha.value){
            ...
            labelconfsenha.innerHTML = "<strong>Senha</strong> *As senhas não estão iguais";
    ...
    estado.addEventListener("blur", () =>{
        if(estado.value == ""){
            ...
            labelEstado.innerHTML = "<strong>Estado/UF</strong> *Não deixe este campo vazio";
    ...
    cidade.addEventListener("keyup", () =>{
        if(cidade.value == ""){
            ...
            labelCidade.innerHTML = "<strong>Cidade</strong> *Não deixe este campo vazio";
            cidade.setAttribute("style", "border-color: red");
            validCidade = false;
        }
        else if(cidade.value.length < 3){
            labelCidade.setAttribute("style", "color: red");
            labelCidade.innerHTML = "<strong>Cidade</strong> *Insira pelo menos 3 caracteres";
            cidade.setAttribute("style", "border-color: red");
            validCidade = false;
        }
        else{
    ...
    bairro.addEventListener("keyup", () =>{
        if(bairro.value == ""){
            ...
            labelBairro.innerHTML = "<strong>Bairro</strong> *Não deixe este campo vazio";
            bairro.setAttribute("style", "border-color: red");
            validBairro = false;
        }
        else if(bairro.value.length < 3){
            labelBairro.setAttribute("style", "color: red");
            labelBairro.innerHTML = "<strong>Bairro</strong> *Insira pelo menos 3 caracteres";
            bairro.setAttribute("style", "border-color: red");
            validBairro = false;
        }
        else{
    ...
    numeroRua.addEventListener("keyup", () =>{
        if(numeroRua.value == ""){
            ...
            labelNumeroRua.innerHTML = "<strong>N° de Endereço</strong> *Não deixe este campo vazio";
    ...
    numeroCelular.addEventListener("keyup", () =>{
        if(numeroCelular.value.length != 11){
            ...
            labelNumeroCelular.innerHTML = "<strong>Número de Celular</strong> *Digite um número válido";
    ...
    idadeDia.addEventListener("blur", () =>{
        if(idadeDia.value == ""){
            ...
            labelIdade.innerHTML = "<strong>Data de Nascimento</strong> *Não deixe este campo vazio";
    ...
    genero.addEventListener("blur", () =>{
        if(genero.value == ""){
            ...
            labelGenero.innerHTML = "<strong>Gênero</strong> *Não deixe este campo vazio";
...
function cadastro(){
    if(validNome && validEmail && validSenha && validConfSenha && validCpf && validIdadeDia && validIdadeMes && validIdadeAno && validEstado && validCidade && validBairro && validRua && validNumeroRua && validComplemento && validNumeroCelular && validGenero){
        console.log("Entrou");
        ...
        setTimeout(() =>{
            window.location.href = "../TIAW - Login/index.html"
        },3000);
    }
    else{
        error1.setAttribute("style", "display: block");
        sucesso1.setAttribute("style", "display: none");
    }
}